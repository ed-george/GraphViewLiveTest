...
public class SimpleGraph extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		graphView.setHorizontalLabels(new String[] {"2 day(s) ago", "yesterday", "today", "tomorrow", "hiya", "test"});
...
//		graphView.setHorizontalLabels(new String[] {"2 day(s) ago", "yesterday", "today", "tomorrow"});
